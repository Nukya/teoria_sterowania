%% Zadanie 8 - Sterowanie z minimalnym wydatkiem (L1)
% Dodatkowe ograniczenia:
%   - narzucone wartości u_0 = u_{N-1} = 0.
% Brak ograniczeń na różnice sterowania (w porównaniu z zadaniami 6 i 7).
...
title('Zadanie 8: sterowanie dyskretne $u(k)$');
grid on;
...
title('Zadanie 8: przebiegi stanu w czasie ciągłym');
grid on;

subplot(3,1,3);
plot(x_c(:,1), x_c(:,2), 'LineWidth', 1.5);
xlabel('$x_1$'); ylabel('$x_2$');
title('Zadanie 8: trajektoria w przestrzeni stanu');
grid on;
