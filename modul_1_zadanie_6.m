% Zadanie 6 – portret fazowy układu van der Pol
clear; 
close all; 
clc;
...
% Normalizacja wektorów dla czytelności
n = sqrt(u.^2 + v.^2);
u_n = u ./ n;
v_n = v ./ n;

% Rysowanie pola wektorowego (portret fazowy)
figure;
...
% Integracja dla różnych warunków początkowych
tFinal = 40;
